...
!(function (e, t) {
    ...
    var k = (function (e) {
            ...
            if (!o && (h(t), (t = t || f), g)) {
                ...
                if (n.qsa && !C[e + " "] && (!m || !m.test(e)) && (1 !== w || "object" !== t.nodeName.toLowerCase())) {
                    if (((y = e), (v = t), 1 === w && (X.test(e) || U.test(e)))) {
                        for (((v = (ee.test(e) && ye(t.parentNode)) || t) === t && n.scope) || ((u = t.getAttribute("id")) ? (u = u.replace(ie, oe)) : t.setAttribute("id", (u = x))), a = (d = s(e)).length; a--; )
        ...
        (ae.matchesSelector = function (e, t) {
            if ((h(e), n.matchesSelector && g && !C[t + " "] && (!y || !y.test(t)) && (!m || !m.test(t))))
                try {
                    var i = v.call(e, t);
                        ...
                        : function (t, n, l) {
                              ...
                              if (m) {
                                  ...
                                  if (((d = [s ? m.firstChild : m.lastChild]), s && v)) {
                                      for (
                                          b = (f = (c = (u = (p = (h = m)[x] || (h[x] = {}))[h.uniqueID] || (p[h.uniqueID] = {}))[e] || [])[0] === _ && c[1]) && c[2], h = f && m.childNodes[f];
                                      ...
                                      for (
                                          ;
                                          (h = (++f && h && h[g]) || (b = f = 0) || d.pop()) &&
                                          ((a ? h.nodeName.toLowerCase() !== y : 1 !== h.nodeType) || !++b || (v && ((u = (p = h[x] || (h[x] = {}))[h.uniqueID] || (p[h.uniqueID] = {}))[e] = [_, b]), h !== t));
        ...
        return (
            ...
            (s = ae.tokenize = function (e, t) {
                ...
                for (a = e, l = [], c = i.preFilter; a; ) {
                    ...
                    (n = !1),
                    (o = U.exec(a)) && ((n = o.shift()), r.push({ value: n, type: o[0].replace(F, " ") }), (a = a.slice(n.length))),
                    i.filter))
    ...
    (w.fn.ready = function (e) {
        ...
        (w.ready.then = W.then),
        "complete" === m.readyState || ("loading" !== m.readyState && !m.documentElement.doScroll) ? e.setTimeout(w.ready) : (m.addEventListener("DOMContentLoaded", z), e.addEventListener("load", z));
    ...
    function be(e, t, n, i, o) {
        ...
        for (p.textContent = "", f = 0; (r = h[f++]); )
            ...
            else if (((c = oe(r)), (s = me(p.appendChild(r), "script")), c && ye(s), n)) for (u = 0; (r = s[u++]); ) de.test(r.type || "") && n.push(r);
        return p;
    }
    var xe = /^([^.]*)(?:\.(.+)|)/;
    function we() {
                ...
                for (
                    ...
                    (f = g = (a = xe.exec(t[c]) || [])[1]),
                        ...
                        f &&
                            ...
                            (p = w.event.special[f] || {}),
                            (u = w.extend({ type: f, origType: g, data: i, handler: n, guid: n.guid, selector: o, needsContext: o && w.expr.match.needsContext.test(o), namespace: d.join(".") }, r)),
                            (h = l[f]) || (((h = l[f] = []).delegateCount = 0), (p.setup && !1 !== p.setup.call(e, i, d, s)) || (e.addEventListener && e.addEventListener(f, s))),
            ...
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(P) || [""]).length; c--; )
                    if (((f = g = (a = xe.exec(t[c]) || [])[1]), (d = (a[2] || "").split(".").sort()), f)) {
                        for (p = w.event.special[f] || {}, h = l[(f = (i ? p.delegateType : p.bindType) || f)] || [], a = a[2] && new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = h.length; r--; )
                            (u = h[r]),
                                (!o && g !== u.origType) ||
                                    (n && n.guid !== u.guid) ||
                ...
                for (u = a[a.length - 1].ownerDocument, w.map(a, Me), p = 0; p < l; p++)
                    (c = a[p]),
                        de.test(c.type || "") &&
                            ...
                            w.contains(u, c) &&
                            (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && !c.noModule && w._evalUrl(c.src, { nonce: c.nonce || c.getAttribute("nonce") }, u) : v(c.textContent.replace(Ae, ""), c, u));
        }
        return e;
    }
    function De(e, t, n) {
    ...
    w.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n) for (r = r || me(e), s = s || me(u), i = 0, o = r.length; i < o; i++) je(r[i], s[i]);
                else je(e, u);
    ...
    function qe(e, t, n) {
        ...
        return (
            (n = n || Ie(e)) &&
                ...
                !f.pixelBoxStyles() && Pe.test(s) && Re.test(t) && ((i = a.width), (o = a.minWidth), (r = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = i), (a.minWidth = o), (a.maxWidth = r))),
            void 0 !== s ? s + "" : s
        );
    }
    function We(e, t) {
    ...
    function Ge(e, t, n) {
        ...
        return (
            ((!f.boxSizingReliable() && o) || (!f.reliableTrDimensions() && C(e, "tr")) || "auto" === s || (!parseFloat(s) && "inline" === w.css(e, "display", !1, i))) &&
    ...
    (w.Animation = w.extend(ct, {
        ...
        (w.speed = function (e, t, n) {
            var i = e && "object" == typeof e ? w.extend({}, e) : { complete: n || (!n && t) || (d(e) && e), duration: e, easing: (n && t) || (t && !d(t) && t) };
            return (
        ...
        w.fn.extend({
            ...
            toggleClass: function (e, t) {
                ...
                return "boolean" == typeof t && i
                    ...
                    : this.each(function () {
                          var t, o, r, s;
                          if (i) for (o = 0, r = w(this), s = mt(e); (t = s[o++]); ) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
    ...
    (Ht.href = xt.href),
            ...
            ajax: function (t, n) {
                ...
                f.hasContent
                    ...
                    : ((h = f.url.slice(o.length)),
                      ...
                      !1 === f.cache && ((o = o.replace(Lt, "$1")), (h = (_t.test(o) ? "&" : "?") + "_=" + wt.guid++ + h)),
                      (f.url = o + h)),
                f.ifModified && (w.lastModified[o] && E.setRequestHeader("If-Modified-Since", w.lastModified[o]), w.etag[o] && E.setRequestHeader("If-None-Match", w.etag[o])),
                ...
                function T(t, n, s, l) {
                    ...
                    c ||
                        ...
                        p
                            ? (f.ifModified && ((_ = E.getResponseHeader("Last-Modified")) && (w.lastModified[o] = _), (_ = E.getResponseHeader("etag")) && (w.etag[o] = _)),
                              204 === t || "HEAD" === f.type ? (k = "nocontent") : 304 === t ? (k = "notmodified") : ((k = x.state), (h = x.data), (p = !(m = x.error))))
                        ...
                        v.fireWith(d, [E, k]),
                        u && (g.trigger("ajaxComplete", [E, f]), --w.active || w.event.trigger("ajaxStop")));
                }
                return E;
            },
        ...
        w.each(["get", "post"], function (e, t) {
            w[t] = function (e, n, i, o) {
                return d(n) && ((o = o || i), (i = n), (n = void 0)), w.ajax(w.extend({ url: e, type: t, dataType: o, data: n, success: i }, w.isPlainObject(e) && e));
            };
        }),
    ...
    w.ajaxSetup({
        ...
        (f.createHTMLDocument = (((Bt = m.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === Bt.childNodes.length)),
    ...
    (function (e, t) {
        ...
        function h(e, o, s) {
            ...
            var h = r(o),
                ...
                d = { x: 0, y: 0 };
            return (
                (h || (!h && !s)) && (("body" !== a(o) || p(u)) && (f = o !== n(o) && r(o) ? { scrollLeft: o.scrollLeft, scrollTop: o.scrollTop } : i(o)), r(o) ? (((d = t(o)).x += o.clientLeft), (d.y += o.clientTop)) : u && (d.x = c(u))),
                { x: e.left + f.scrollLeft - d.x, y: e.top + f.scrollTop - d.y, width: e.width, height: e.height }
            );
        }
        function f(e) {
            var n = t(e),
        ...
        function L(e, n) {
            ...
            (c = e.rects.popper),
                ...
                (u = C({ reference: (a = t(p)), element: c, strategy: "absolute", placement: n })),
        ...
        function j(e) {
            ...
            return function (e, t, r) {
                ...
                void 0 === r && (r = i);
                var a = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, X, i), modifiersData: {}, elements: { reference: e, popper: t }, attributes: {}, styles: {} },
                    l = [],
                    c = !1,
                    u = {
                        state: a,
                        setOptions: function (r) {
                            return (
                                ...
                                (a.scrollParents = { reference: o(e) ? m(e) : e.contextElement ? m(e.contextElement) : [], popper: m(t) }),
                                (r = (function (e) {
                                    var t = b(e);
                        ...
                        forceUpdate: function () {
                            if (!c) {
                                ...
                                if (M(t, (e = e.popper)))
                                    for (
                                        a.rects = { reference: h(t, v(e), "fixed" === a.options.strategy), popper: f(e) },
                                            a.reset = !1,
        ...
        function N(e) {
            ...
            if (p) {
                ...
                b === n(i) && "static" !== u((b = l(i))).position && ((x = "scrollHeight"), (w = "scrollWidth")),
                    "top" === r && ((m = "bottom"), (h -= b[x] - o.height), (h *= c ? 1 : -1)),
                    "left" === r && ((g = "right"), (e -= b[w] - o.width), (e *= c ? 1 : -1));
            }
            return (
                (i = Object.assign({ position: a }, p && K)),
                c
                    ? Object.assign({}, i, (((d = {})[m] = s ? "0" : ""), (d[g] = f ? "0" : ""), (d.transform = 2 > (y.devicePixelRatio || 1) ? "translate(" + e + "px, " + h + "px)" : "translate3d(" + e + "px, " + h + "px, 0)"), d))
                    : Object.assign({}, i, (((t = {})[m] = s ? h + "px" : ""), (t[g] = f ? e + "px" : ""), (t.transform = ""), t))
            );
        }
        function D(e) {
        ...
        var R = ["top", "bottom", "right", "left"],
            ...
            $ = {
                ...
                fn: function (e) {
                    var t = e.state;
                    t.modifiersData[e.name] = C({ reference: t.rects.reference, element: t.rects.popper, strategy: "absolute", placement: t.placement });
                },
                data: {},
            },
            ...
            ne = {
                ...
                fn: function (e) {
                    ...
                    var s = n.tetherOffset,
                        a = void 0 === s ? 0 : s,
                        l = L(t, { boundary: n.boundary, rootBoundary: n.rootBoundary, padding: n.padding, altBoundary: n.altBoundary });
                    n = w(t.placement);
                    ...
                    if (((a = { x: 0, y: 0 }), s)) {
                        if (o || r) {
                            ...
                            var C = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : { top: 0, right: 0, bottom: 0, left: 0 };
                            (m = C[m]),
                                (y = C[y]),
                                (d = F(0, B(h[b], d[b]))),
                                ...
                                (h = s[p] + h - g),
                                o && ((o = i ? B(_, u) : _), (k = i ? F(k, h) : k), (o = F(o, B(x, k))), (s[p] = o), (a[p] = o - x)),
                                r && ((o = (r = s[n]) + l["x" === p ? "top" : "left"]), (l = r - l["x" === p ? "bottom" : "right"]), (o = i ? B(o, u) : o), (i = i ? F(l, h) : l), (i = F(o, B(r, i))), (s[n] = i), (a[n] = i - r));
                        }
                        t.modifiersData[e] = a;
                    }
                },
    ...
    (function (e, t) {
        ...
        class J extends H {
            ...
            _addEventListeners() {
                this._config.keyboard && D.on(this._element, "keydown.bs.carousel", (e) => this._keydown(e)),
                    "hover" === this._config.pause && (D.on(this._element, "mouseenter.bs.carousel", (e) => this.pause(e)), D.on(this._element, "mouseleave.bs.carousel", (e) => this.cycle(e))),
            ...
            _addTouchEventListeners() {
                ...
                U.find(".carousel-item img", this._element).forEach((e) => {
                    ...
                    this._pointerEvent
                        ? (D.on(this._element, "pointerdown.bs.carousel", (t) => e(t)), D.on(this._element, "pointerup.bs.carousel", (e) => n(e)), this._element.classList.add("pointer-event"))
                        : (D.on(this._element, "touchstart.bs.carousel", (t) => e(t)), D.on(this._element, "touchmove.bs.carousel", (e) => t(e)), D.on(this._element, "touchend.bs.carousel", (e) => n(e)));
            }
            _keydown(e) {
        ...
        function ve(e, t) {
            ...
            var n = e.getBoundingClientRect(),
                ...
                o = 1;
            return (
                fe(e) && t && ((i = n.width / e.offsetWidth || 1), (o = n.height / e.offsetHeight || 1)),
                { width: ye(n.width / i), height: ye(n.height / o), top: ye(n.top / o), right: ye(n.right / i), bottom: ye(n.bottom / o), left: ye(n.left / i), x: ye(n.left / i), y: ye(n.top / o) }
            );
        }
        function be(e) {
            var t = ve(e),
        ...
        function Se(e) {
            ...
            return n && ("html" === ue(n) || ("body" === ue(n) && "static" === we(n).position))
                ? t
                : n ||
                      (function (e) {
        ...
        function Ie(e) {
            ...
            if (l) {
                var x = Se(n),
                    w = "clientHeight",
                    _ = "clientWidth";
                x === pe(n) && "static" !== we((x = ke(n))).position && ((w = "scrollHeight"), (_ = "scrollWidth")),
                    (x = x),
            ...
            return a
                ? Object.assign({}, E, (((k = {})[v] = m ? "0" : ""), (k[y] = g ? "0" : ""), (k.transform = (b.devicePixelRatio || 1) < 2 ? "translate(" + h + "px, " + d + "px)" : "translate3d(" + h + "px, " + d + "px, 0)"), k))
                : Object.assign({}, E, (((t = {})[v] = m ? d + "px" : ""), (t[y] = g ? h + "px" : ""), (t.transform = ""), t));
        }
        var He = {
                name: "computeStyles",
                enabled: !0,
                ...
                fn: function (e) {
                    var t = e.state,
                        ...
                        a = n.roundOffsets,
                        l = void 0 === a || a,
                        c = { placement: me(t.placement), popper: t.elements.popper, popperRect: t.rects.popper, gpuAcceleration: o };
                    null != t.modifiersData.popperOffsets &&
                        (t.styles.popper = Object.assign({}, t.styles.popper, Ie(Object.assign({}, c, { offsets: t.modifiersData.popperOffsets, position: t.options.strategy, adaptive: s, roundOffsets: l })))),
                        null != t.modifiersData.arrow && (t.styles.arrow = Object.assign({}, t.styles.arrow, Ie(Object.assign({}, c, { offsets: t.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: l })))),
                        (t.attributes.popper = Object.assign({}, t.attributes.popper, { "data-popper-placement": t.placement }));
                },
                data: {},
            },
                ...
                ? $e(
                      (function (e) {
                          var t = pe(e),
                              ...
                              s = 0,
                              a = 0;
                          return i && ((o = i.width), (r = i.height), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || ((s = i.offsetLeft), (a = i.offsetTop))), { width: o, height: r, x: s + Xe(e), y: a };
                      })(e)
                  )
                : fe(t)
                ? (function (e) {
                ...
                : $e(
                      (function (e) {
                          var t,
                              ...
                              a = -i.scrollLeft + Xe(e),
                              l = -i.scrollTop;
                          return "rtl" === we(o || n).direction && (a += Ae(n.clientWidth, o ? o.clientWidth : 0) - r), { width: r, height: s, x: a, y: l };
                      })(ke(e))
                  );
        }
        function Qe(e) {
        ...
        function Je(e, t) {
            ...
            var n = t,
                ...
                w = ve(y),
                _ = Ge({ reference: w, element: v, strategy: "absolute", placement: o }),
                k = $e(Object.assign({}, v, _)),
                E = "popper" === u ? k : w,
                T = { top: x.top - E.top + g.top, bottom: E.bottom - x.bottom + g.bottom, left: x.left - E.left + g.left, right: E.right - x.right + g.right },
                                ...
                                return e.concat(
                                    "auto" === me(n)
                                        ? (function (e, t) {
                                          ...
                                          })(t, { placement: n, boundary: u, rootBoundary: p, padding: c, flipVariations: d, allowedAutoPlacements: g })
                                        : n
                                );
                            }, []),
                            x = t.rects.reference,
        ...
        var nt = {
                ...
                fn: function (e) {
                    var t = e.state,
                        ...
                        u = tt(l),
                        p = tt(c);
                    (t.modifiersData[n] = { referenceClippingOffsets: l, popperEscapeOffsets: c, isReferenceHidden: u, hasPopperEscaped: p }),
                        (t.attributes.popper = Object.assign({}, t.attributes.popper, { "data-popper-reference-hidden": u, "data-popper-escaped": p }));
                },
            },
            it = {
                name: "offset",
                            ...
                            return (
                                (e[n] = (function (e, t, n) {
                                    var i = me(e),
                                        ...
                                        r = "function" == typeof n ? n(Object.assign({}, t, { placement: e })) : n,
                                        s = r[0],
                                        a = r[1];
            ...
            rt = {
                ...
                fn: function (e) {
                    var t = e.state,
                        ...
                        d = n.tetherOffset,
                        g = void 0 === d ? 0 : d,
                        m = Je(t, { boundary: l, rootBoundary: c, padding: p, altBoundary: u }),
                        y = me(t.placement),
                        v = Qe(t.placement),
                        b = !v,
                        x = Ce(y),
        ...
        function st(e, t, n) {
            ...
            return (
                (r || (!r && !n)) &&
                    (("body" !== ue(t) || Ye(a)) && (c = (i = t) !== pe(i) && fe(i) ? { scrollLeft: (o = i).scrollLeft, scrollTop: o.scrollTop } : Ue(i)),
                    fe(t) ? (((u = ve(t, !0)).x += t.clientLeft), (u.y += t.clientTop)) : a && (u.x = Xe(a))),
        ...
        function ct(e) {
            ...
            return function (e, t, n) {
                ...
                var o,
                    s,
                    a = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, at, r), modifiersData: {}, elements: { reference: e, popper: t }, attributes: {}, styles: {} },
                    l = [],
                    c = !1,
                    u = {
                        state: a,
                        setOptions: function (n) {
                            p(), (a.options = Object.assign({}, r, a.options, n)), (a.scrollParents = { reference: he(e) ? Ve(e) : e.contextElement ? Ve(e.contextElement) : [], popper: Ve(t) });
                            var o,
                                s,
                                c = (function (e) {
                                    var t = (function (e) {
                        ...
                        forceUpdate: function () {
                            if (!c) {
                                var e = a.elements,
                                    ...
                                    n = e.popper;
                                if (lt(t, n)) {
                                    (a.rects = { reference: st(t, Se(n), "fixed" === a.options.strategy), popper: be(n) }),
                                        (a.reset = !1),
                                        (a.placement = a.options.placement),
                                        a.orderedModifiers.forEach(function (e) {
                                            return (a.modifiersData[e.name] = Object.assign({}, e.data));
        ...
        const dt = new RegExp("ArrowUp|ArrowDown|Escape"),
            ...
            _t = { offset: "(array|string|function)", boundary: "(string|element)", reference: "(string|element|object)", display: "string", popperConfig: "(null|object|function)", autoClose: "(boolean|string)" };
        class kt extends H {
            constructor(e, t) {
            ...
            _getConfig(e) {
                if (
                    ((e = { ...this.constructor.Default, ...B.getDataAttributes(this._element), ...e }),
        ...
        const Tt = { className: "modal-backdrop", isVisible: !0, isAnimated: !1, rootElement: "body", clickCallback: null },
            St = { className: "string", isVisible: "boolean", isAnimated: "boolean", rootElement: "(element|string)", clickCallback: "(function|null)" };
        class Ct {
            constructor(e) {
        ...
        class Lt {
            ...
            activate() {
                ...
                this._isActive ||
                    (t && e.focus(), D.off(document, ".bs.focustrap"), D.on(document, "focusin.bs.focustrap", (e) => this._handleFocusin(e)), D.on(document, "keydown.tab.bs.focustrap", (e) => this._handleKeydown(e)), (this._isActive = !0));
            }
            deactivate() {
        ...
        class Nt extends H {
            ...
            show(e) {
                this._isShown ||
                    ...
                    D.trigger(this._element, "show.bs.modal", { relatedTarget: e }).defaultPrevented ||
                    ((this._isShown = !0),
        ...
        class It extends H {
            ...
            show(e) {
                this._isShown ||
                    D.trigger(this._element, "show.bs.offcanvas", { relatedTarget: e }).defaultPrevented ||
                    ((this._isShown = !0),
            ...
            _initializeBackDrop() {
                return new Ct({ className: "offcanvas-backdrop", isVisible: this._config.backdrop, isAnimated: !0, rootElement: this._element.parentNode, clickCallback: () => this.hide() });
            }
            _initializeFocusTrap() {
                return new Lt({ trapElement: this._element });
            }
        ...
        class Vt extends H {
            ...
            show() {
                ...
                I.set(i, this.constructor.DATA_KEY, this),
                    this._element.ownerDocument.documentElement.contains(this.tip) || (a.append(i), D.trigger(this._element, this.constructor.Event.INSERTED)),
            ...
            setElementContent(e, t) {
                if (null !== e)
                    return o(t)
                        ...
                        : void (this._config.html ? (this._config.sanitize && (t = zt(t, this._config.allowList, this._config.sanitizeFn)), (e.innerHTML = t)) : (e.textContent = t));
            }
            getTitle() {
            ...
            _activate(e) {
                ...
                n.classList.add("active"),
                    n.classList.contains("dropdown-item")
                        ? U.findOne(".dropdown-toggle", n.closest(".dropdown")).classList.add("active")
        ...
        return R(sn), g(sn), { Alert: q, Button: W, Carousel: J, Collapse: te, Dropdown: kt, Modal: Nt, Offcanvas: It, Popover: Gt, ScrollSpy: tn, Tab: nn, Toast: sn, Tooltip: Vt };
    }),
    /*!
        ...
        function h(e, t, n, i, o) {
            ...
            !(function (e, t, n, i, o) {
                ...
                (e.reach[l] = null),
                    ...
                    t && (f.dispatchEvent(p("ps-scroll-" + l)), 0 > t ? f.dispatchEvent(p("ps-scroll-" + c)) : 0 < t && f.dispatchEvent(p("ps-scroll-" + h)), i && u(e, l)),
        ...
        var T = {
                    ...
                    function p() {
                        i.settings.swipeEasing &&
                            ...
                            (y = setInterval(function () {
                                return i.isInitialized ? void clearInterval(y) : m.x || m.y ? (0.01 > e(m.x) && 0.01 > e(m.y) ? void clearInterval(y) : (r(30 * m.x, 30 * m.y), (m.x *= 0.8), void (m.y *= 0.8))) : void clearInterval(y);
                            }, 10)));
                    }
            ...
            C = function (e, r) {
                ...
                (this.scrollbarXBottom = parseInt(u.bottom, 10)),
                    isNaN(this.scrollbarXBottom) ? ((this.isScrollbarXUsingBottom = !1), (this.scrollbarXTop = f(u.top))) : (this.isScrollbarXUsingBottom = !0),
                ...
                (this.scrollbarYRight = parseInt(p.right, 10)),
                    isNaN(this.scrollbarYRight) ? ((this.isScrollbarYUsingRight = !1), (this.scrollbarYLeft = f(p.left))) : (this.isScrollbarYUsingRight = !0),
    ...
    (function (e, t, n, i) {
        ...
        l(M, _, {
            handler: function (e) {
                ...
                t & be && 0 === e.button && (this.pressed = !0),
                    t & xe && 1 !== e.which && (t = we),
                    this.pressed && (t & we && (this.pressed = !1), this.callback(this.manager, t, { pointers: [e], changedPointers: [e], pointerType: ye, srcEvent: e }));
            },
        });
        ...
        l(N, _, {
            handler: function (e) {
                ...
                if ((t === be && (this.started = !0), this.started)) {
                    ...
                    t & (we | _e) && n[0].length - n[1].length == 0 && (this.started = !1), this.callback(this.manager, t, { pointers: n[0], changedPointers: n[1], pointerType: me, srcEvent: e });
                }
            },
        });
        ...
        (F.prototype = {
            ...
            l(V, Y, {
                ...
                directionTest: function (e) {
                    var t = this.options,
                        ...
                        s = e.deltaY;
                    return (
                        o & t.direction || (t.direction & Ae ? ((o = 0 === r ? ke : 0 > r ? Ee : Te), (n = r != this.pX), (i = Math.abs(e.deltaX))) : ((o = 0 === s ? ke : 0 > s ? Se : Ce), (n = s != this.pY), (i = Math.abs(e.deltaY)))),
                        (e.direction = o),
            ...
            l(G, Y, {
                defaults: { event: "swipe", threshold: 10, velocity: 0.3, direction: Ae | Oe, pointers: 1 },
                getTouchAction: function () {
                ...
                attrTest: function (e) {
                    ...
                    return (
                        n & (Ae | Oe) ? (t = e.overallVelocity) : n & Ae ? (t = e.overallVelocityX) : n & Oe && (t = e.overallVelocityY),
            ...
            (Z.defaults = {
                ...
                inputTarget: null,
                inputClass: null,
                preset: [[Q, { enable: !1 }], [$, { enable: !1 }, ["rotate"]], [G, { direction: Ae }], [V, { direction: Ae }, ["swipe"]], [J], [J, { event: "doubletap", taps: 2 }, ["tap"]], [K]],
            ...
            function t(t, i) {
                ...
                if (!(i = e.extend({}, e.blockUI.defaults, i || {})).ignoreIfBlocked || !e(t).data("blockUI.isBlocked")) {
                    ...
                    (b = e(
                        ...
                        (w = e(_)),
                        m && (i.theme ? (w.css(d), w.addClass("ui-widget-content")) : w.css(r)),
                    ...
                    if (
                        (o(1, t, i),
                        g
                            ? ((h = w[0]), (f = e(i.focusableElements, h)), i.focusInput && setTimeout(s, 20))
                            : (function (e, t, n) {
                                  var i = e.parentNode,
                                      o = e.style,
        ...
        K(J, (Y = Error)),
            ...
            (_ = function () {
                ...
                var n,
                    ...
                    r = e.url;
                if (!j(r))
                    return s.running || (!1 === C.restartOnRequestAfter && "force" !== N(i))
                        ? void 0
                        : ((n = arguments),
                ...
                (this.progress = 0),
                    ...
                    (t = setInterval(function () {
                        ...
                        return (
                            ...
                            (e = d(o)),
                            ++i >= C.eventLag.minSamples && e < C.eventLag.lagThreshold ? ((r.progress = 100), clearInterval(t)) : (r.progress = (3 / (e + 3)) * 100)
                        );
                    }, 50));
            }),
            (se.prototype.tick = function (e, t) {
                return (
                    ...
                    t === this.last
                        ...
                        : (this.sinceLastUpdate && (this.rate = (t - this.last) / this.sinceLastUpdate), (this.catchup = (t - this.progress) / C.catchupTime), (this.sinceLastUpdate = 0), (this.last = t)),
                ...
                return (
                    ...
                    (f = L(function (t, n) {
                        ...
                        for (var i, o, r, a, l, u, p, h, f, d, y = (u = 0), v = !0, b = (p = 0), x = P.length; p < x; b = ++p)
                            for (D = P[b], l = null != M[b] ? M[b] : (M[b] = []), r = h = 0, f = (o = null != (d = D.elements) ? d : [D]).length; h < f; r = ++h)
                                (a = o[r]), (v &= (a = null != l[r] ? l[r] : (l[r] = new c(a))).done), a.done || (y++, (u += a.tick(t)));
                        return (
                            (i = u / y),
                            g.update(I.tick(t, i)),
                            g.done() || v || m
                                    ...
                                    if (C || S || O) {
                                        ...
                                        var D = function (e, t) {
                                            r.options.missingKeyHandler
                                                ? r.options.missingKeyHandler(e, u, t, O ? i.defaultValue : g, O, i)
                                                : r.backendConnector && r.backendConnector.saveMissing && r.backendConnector.saveMissing(e, u, t, O ? i.defaultValue : g, O, i),
                                            ...
                                            u.forEach(function (e) {
                                                s.isValidLookup(t) ||
                                                    ...
                                                    !S["".concat(f[0], "-").concat(e)] &&
                                                        ...
                                                        s.logger.warn(
                                                            'key "'.concat(n, '" for languages "').concat(f.join(", "), '" won\'t get resolved as namespace "').concat(r, '" was not yet loaded'),
  ...
  */ !(function () {
            ...
            function (e, t, n) {
                ...
                e.exports = function (e) {
                    var t,
                        ...
                        y = 0,
                        v = c(h);
                    if ((m && (g = i(g, d > 2 ? arguments[2] : void 0, 2)), null == v || (f == Array && s(v)))) for (n = new f((t = a(h.length))); t > y; y++) l(n, y, m ? g(h[y], y) : h[y]);
                    else for (p = v.call(h), n = new f(); !(u = p.next()).done; y++) l(n, y, m ? r(p, g, [u.value, y], !0) : u.value);
                    return (n.length = y), n;
                };
            },
            function (e, t, n) {
            ...
            function (e, t, n) {
                ...
                e.exports = function (e, t, n, u, f, v, b) {
                    ...
                    if (
                        (O && ((x = r(O.call(new e()))), d !== Object.prototype && x.next && (p || r(x) === d || (s ? s(x, d) : "function" != typeof x[m] && l(x, m, y)), a(x, E, !0, !0), p && (h[E] = y))),
                        "values" == f &&
                            C &&
                            "values" !== C.name &&
                            ((T = !0),
                        ...
                        if (((w = { values: k("values"), keys: v ? A : k("keys"), entries: k("entries") }), b)) for (_ in w) (!g && !T && _ in S) || c(S, _, w[_]);
