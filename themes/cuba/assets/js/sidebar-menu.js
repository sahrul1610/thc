    ...
    if (localStorage.getItem("page-wrapper") === null) {
        ...
        $(".page-body-wrapper").addClass("horizontal-menu");
    }
    ...
    if($('#pageWrapper').hasClass('compact-wrapper')){
        ...
        jQuery('.menu-title').append('<div class="according-menu"><i class="fa fa-angle-right"></i></div>');
          jQuery('.menu-title').click(function () {
              jQuery('.menu-title').removeClass('active bg-primary').find('div').replaceWith('<div class="according-menu"><i class="fa fa-angle-right"></i></div>');
              jQuery('.menu-content').slideUp('normal');
              if (jQuery(this).next().is(':hidden') == true) {
                  jQuery(this).addClass('active bg-primary');
          ...
          jQuery('.submenu-title').click(function () {
              jQuery('.submenu-title').removeClass('active bg-primary').find('div').replaceWith('<div class="according-menu"><i class="fa fa-angle-right"></i></div>');
        ...
        if ((contentwidth) < '992') {
            ...
            jQuery('.submenu-title').append('<div class="according-menu"><i class="fa fa-angle-right"></i></div>');
          jQuery('.submenu-title').click(function () {
              jQuery('.submenu-title').removeClass('active bg-primary');
          ...
          jQuery('.menu-title').append('<div class="according-menu"><i class="fa fa-angle-right"></i></div>');
          jQuery('.menu-title').click(function () {
              jQuery('.menu-title').removeClass('active bg-primary');
...
// page active bg-primary
    $( ".main-navbar" ).find( "a" ).removeClass("active bg-primary");
    $( ".main-navbar" ).find( "li" ).removeClass("active bg-primary");
    ...
    $(".main-navbar ul>li a").filter(function() {
        ...
        if(link){
            if (current.indexOf(link) != -1) {
                $(this).parents().children('a').addClass('active bg-primary');
