...
class EducationlevelController extends Controller
{
	...
	private function _getKey(){
		return $this->id == 'educationlevel' ? 'education_level' : '';
	}
	...
	public function actionLoaddtdatarepository()
    {
        if (Yii::$app->request->isAjax) {
			...
			$datawhere->andWhere(['parent_id'=>Yii::$app->user->identity->employee->company_id, 'key'=>$this->_getKey(), 'is_active'=>Logic::statusActive()]);
